                            ...
                            <div class="form-group">
                              <label class="form-label">Total Ongoing Projects<span style="color:red;" >*</span></label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" required class="form-control" name="total_ongoing_projects" required data-parsley-error-message="Please enter valid data." data-parsley-pattern="^[0-9 .]+$">
                                  </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Total Done Projects<span style="color:red;" >*</span></label>
                              <div class="input-group input-group-outline mb-3">
                                  <input type="text" required class="form-control" name="total_done_projects" required data-parsley-error-message="Please enter valid data." data-parsley-pattern="^[0-9 .]+$">
                                </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                          <label class="form-label">Total Sold Plots<span style="color:red;" >*</span></label>
                            <div class="input-group input-group-outline mb-3">
                                <input type="text" required class="form-control" name="total_sold_plots" required data-parsley-error-message="Please enter valid data." data-parsley-pattern="^[0-9 .]+$">
                              </div>
                        </div>
                    </div>
                </div>
