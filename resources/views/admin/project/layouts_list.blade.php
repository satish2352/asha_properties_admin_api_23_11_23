              ...
              <div class="table-responsive p-0">
                <table id ="example" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php 
                    $project = \DB::table('projects')->where('id',$value->project_id)->first();
                    ?>
                      <tr>
                        <td>
                          {{$key+1}}
                        ...
                        <td>
                          <img src="{{ Config::get('DocumentConstant.MAIN_LAYOUT_VIEW') }}{{ $project->main_layout_image }}" height="50px" width="60px">
                        </td>
                        <td>
                          <img src="{{ Config::get('DocumentConstant.LAYOUT_VIEW') }}{{ $value->images }}" height="50px" width="60px">
                        </td>
                       
                        <td>
                          <a href="{{url('/')}}/add_sub_layouts/{{$value->id}}" class="btn btn-primary btn-xs">Add Sub Layouts</a>
                        </td>
                      </tr>
                    @endforeach
                  </tbody>
